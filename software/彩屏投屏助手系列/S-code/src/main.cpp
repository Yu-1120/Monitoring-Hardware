...
uint8_t buff[70000] PROGMEM= {0};//每一帧的临时缓存
uint8_t img_buff[100000] PROGMEM= {0};//用于存储tcp传过来的图片，注意图片大小不要超出内存，分辨率高的屏幕可以扩容
