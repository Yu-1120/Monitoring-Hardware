...
#define SPI_SCK_0  digitalWrite(2,LOW)             
#define SPI_SCK_1  digitalWrite(2,HIGH) 
#define SPI_SDA_0  digitalWrite(3,LOW)               
#define SPI_SDA_1  digitalWrite(3,HIGH)
#define SPI_RST_0  digitalWrite(10,LOW)               
#define SPI_RST_1  digitalWrite(10,HIGH)
...
#define SPI_BLK_0 digitalWrite(11,LOW)
#define SPI_BLK_1 digitalWrite(11,HIGH)
...
void  LCD_Test(){
    ...
    delay(1000);
    TFT_clear();
    display_char16_16(20,80,BLUE,0);
    display_char16_16(36,80,GREEN,1);
